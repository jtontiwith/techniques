  ...
  <nav class="flex items-center h-20 bg-white border-b border-blue-100 mb-7">
    <div class="flex-1 max-w-full px-2 sm:px-4 lg:px-8">
      <div class="flex justify-between">
        ...
        <div class="flex px-2 lg:px-0">
          <NuxtLink to="/">
            <div class="flex items-center flex-shrink-0">
              <img
                class="block w-auto h-10 sm:h-11"
                src="~/assets/logo.jpg"
                alt="Workflow"
              />
            </div>
            ...
            <div class="w-full max-w-lg lg:max-w-xs">
              ...
              <div class="relative">
                ...
                >
                  ...
                  <svg
                    class="hidden w-5 h-5 text-gray-400 xl:block"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
                ...
                <input
                  name="search"
                  class="hidden w-full py-2 pl-10 pr-3 leading-5 placeholder-gray-500 border border-transparent rounded-sm  xl:block bg-primary-input focus:border-transparent focus:ring-0 focus:placeholder-gray-400 sm:text-sm"
          ...
          <div class="hidden xl:flex lg:ml-8 lg:space-x-8">
            ...
            <a
              href="#"
              class="inline-flex items-center px-1 pt-1 text-base font-medium text-gray-500 "
            >
              Community
            </a>
            <a
        ...
        <div class="flex items-center lg:ml-4 lg:space-x-8">
          <!--<button
            type="button"
          ...
          <div class="hidden xl:flex">How to publish a technique?</div>
          <div>Sign In</div>
          <button
            type="button"
            class="items-center hidden px-4 py-2 text-sm font-medium text-white bg-indigo-600 border border-transparent rounded-sm shadow-sm  xl:inline-flex hover:primary-button focus:outline-none"
          >
            Sign Up
          </button>
        </div>
